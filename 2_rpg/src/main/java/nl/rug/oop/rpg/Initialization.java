...
import nl.rug.oop.rpg.doors.Exit;
...
public class Initialization {
    ...
    public Player setup() {
        ...
        Room room4 = new Room("A dark forest");
        ...
        Door exit = new Exit("A sturdy wooden door with an interesting looking key hole", room2, room4);
        room1.addDoor(door);
        room2.addDoor(door);
        room1.addDoor(door2);
        room3.addDoor(door2);
        ...
        room2.addDoor(exit);
        room4.addDoor(exit);
        NPC char1 = new Enemy("A dancing cheery strawberry", 2, 10, 50, false);
        NPC char2 = new Healer("An odd looking dirty kobold", 1, 7, 100, false);
        NPC char3 = new Wizard("A magical wizard in a large hat", 3, 8, 0, false);
        NPC char4 = new Trader("A nervous looking man pacing back and forth", 1, 6, 1000, false);
        NPC char5 = new Enemy("A large fire spitting dragon", 6, 15, 0, true);
        room1.addNPC(char1);
        room1.addNPC(char2);
        room2.addNPC(char3);
        room3.addNPC(char4);
        room3.addNPC(char5);
        return new Player("Player1", room1, 3, 10, 0, 0,false);
    }
}
